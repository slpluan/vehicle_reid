    ...
    for epoch in range(1, epochs + 1):
        ...
        for n_iter, (img, vid) in enumerate(train_loader):
            ...
            if (n_iter + 1) % log_period == 0:
                print("Epoch[{}] Iteration[{}/{}] Loss: {:.3f},Base Lr: {:.2e}".format(epoch, (n_iter + 1), len(train_loader), loss_meter.avg,scheduler.get_lr()[0]))
        ...
        print("Epoch {} done. Time per batch: {:.3f}[s] Speed: {:.1f}[samples/s]".format(epoch, time_per_batch, train_loader.batch_size / time_per_batch))
