...
class DefaultConfig:
    ...
    def __init__(self):
        self.PROJECT_NAME = 'vehicle-reid'  # project name
        ...
        self.LOG_PERIOD = 1000  # iteration of displaying training log
        ...
        # data
        self.DATA_DIR = "E:\data"  # dataset path
        self.DATALOADER_NUM_WORKERS = 0  # number of dataloader workers
        self.SAMPLER = 'triplet'  # batch sampler, option: 'triplet','softmax'
        self.BATCH_SIZE = 42  # MxN, M: number of persons, N: number of images of per person
        self.NUM_IMG_PER_ID = 6  # N, number of images of per vehicle
        ...
        self.PRETRAIN_PATH = "F:/vehicle_reid/config/resnet50-19c8e357.pth"  # pretrained weight path
        ...
        # solver
        self.OPTIMIZER = 'Adam'  # optimizer 'SGD'
        self.BASE_LR = 0.00035  # base learning rate 3e-4  0.01
        ...
        self.FEAT_NORM = "yes"
        self.TEST_WEIGHT = './output/veri训练的结果/resnet50_170.pth'
        ...
        # self.QUERY_DIR = 'E:/data/veri/image_query/
